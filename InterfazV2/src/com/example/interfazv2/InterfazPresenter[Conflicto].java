...
public class InterfazPresenter1 implements InterfazVistas.ViewListener {
...
@Override
	public void proponerNuevoJugador(String nombre, String apellido,int dni, int edad, Partido partido,
			Administrador admin, Jugador jugador) {
	// // TODO Auto-generated method stub
		//this.jugador.proponerAmigo((Amigo)jugadorPropuesto, null, null);
		
		this.jugador.proponerJugador(nombre, apellido, dni, edad, partido, admin, jugador);
	}
	...
	@Override
	public void aceptarONoJugadorNuevo(Jugador jugador, boolean aprobado, String motivo){
		this.admin.aceptarONo(jugador, aprobado, motivo);
	}
