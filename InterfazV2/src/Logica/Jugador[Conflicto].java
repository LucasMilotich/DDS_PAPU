...
public class Jugador1 extends ObservableJugadores implements Serializable {
	...
	public void proponerJugador(String nombre, String apellido, int dni,
		...
		try {
			...
			bd.crearJugadorParaAprobar(dni, partido);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void proponerJugador(String nombre, String apellido, int dni,
		...
		try {
			...
			bd.getConnection();
			bd.crearJugador(dni, nombre, apellido, edad);
			bd.crearJugadorParaAprobar(dni, partido, jugadorProponedor.DNI);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
